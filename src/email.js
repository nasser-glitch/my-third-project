...
const T_ADVANCE = import.meta.env.VITE_EMAILJS_TEMPLATE_ADVANCE;
...
export function sendAdvanceEmail(email, name, teamName, stageLabel) {
  return send(T_ADVANCE, { to_email: email, participant_name: name, team_name: teamName, stage_label: stageLabel });
}
